...
<head>
    ...
    <title>Welcome to Stock Watchlist</title>
    <!--[if mso]>
    <noscript>
        <xml>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <span style="font-size:20px;font-weight:700;color:#FDD458;letter-spacing:-0.02em;">Stock Watchlist</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               Stock Watchlist HQ, 200 Market Street, San Francisco, CA 94105<br>
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Visit Stock Watchlist</a><br>
                                © 2025 Stock Watchlist
                            </p>
                        </td>
                    </tr>
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    You're receiving this because you subscribed to Stock Watchlist news updates.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Visit Stock Watchlist</a>
                                </p>
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="x-apple-disable-message-reformatting">
    <title>What changed on your watchlist</title>
    <style type="text/css">
        @media (prefers-color-scheme: dark) {
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color:#050505;">
        <tr>
            <td align="center" style="padding:40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width:600px;background-color:#141414;border-radius:8px;border:1px solid #30333A;">
                    <tr>
                        <td align="left" class="mobile-padding" style="padding:40px 40px 12px 40px;">
                            <span style="font-size:20px;font-weight:700;color:#FDD458;letter-spacing:-0.02em;">Stock Watchlist</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="mobile-padding" style="padding:20px 40px 40px 40px;">
                            <h1 class="dark-text" style="margin:0 0 6px 0;font-size:22px;font-weight:600;color:#FDD458;">Since you last checked</h1>
                            <p class="dark-text-secondary" style="margin:0 0 8px 0;font-size:14px;color:#6b7280;">{{date}}</p>
                            <p class="dark-text-secondary" style="margin:0 0 24px 0;font-size:15px;line-height:1.6;color:#CCDADC;">{{summaryLine}}</p>
                            {{body}}
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:32px 0 0 0;">
                                <tr><td align="center">
                                    <a href="{{watchlistUrl}}" style="display:block;width:100%;background:#E8BA40;color:#000;text-decoration:none;padding:14px 28px;border-radius:8px;font-size:15px;font-weight:500;text-align:center;box-sizing:border-box;">Open your watchlist</a>
                                </td></tr>
                            </table>
                            <p style="margin:32px 0 0 0;font-size:13px;line-height:1.5;color:#CCDADC;text-align:center;">
                                You get this because items on your watchlist have <code>notify</code> on.<br>© 2026 Stock Watchlist
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td align="center" style="padding:40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width:600px;background-color:#141414;border-radius:8px;border:1px solid #30333A;">
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding:20px 40px 40px 40px;">
                            <h1 style="margin:0 0 16px 0;font-size:22px;font-weight:600;color:#FDD458;">Reset your password</h1>
                            <p class="dark-text-secondary" style="margin:0 0 24px 0;font-size:15px;line-height:1.6;color:#CCDADC;">
                                Hi {{name}}, we got a request to reset the password on your Stock Watchlist account. This link works for the next hour:
                            </p>
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr><td align="center">
                                    <a href="{{resetUrl}}" style="display:block;width:100%;background:#E8BA40;color:#000;text-decoration:none;padding:14px 28px;border-radius:8px;font-size:15px;font-weight:600;text-align:center;box-sizing:border-box;">Choose a new password</a>
                                </td></tr>
                            </table>
                            <p class="dark-text-secondary" style="margin:24px 0 0 0;font-size:13px;line-height:1.6;color:#9ca3af;">
                                If the button doesn't work, paste this into your browser:<br>
                                <span style="color:#CCDADC;word-break:break-all;">{{resetUrl}}</span>
                            </p>
                            <p class="dark-text-secondary" style="margin:24px 0 0 0;font-size:13px;line-height:1.6;color:#6b7280;">
                                Didn't ask for this? You can safely ignore this email — your password won't change.
                            </p>
                            <p style="margin:32px 0 0 0;font-size:13px;color:#CCDADC;text-align:center;">© 2026 Stock Watchlist</p>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="#" style="display: block; width: 100%; max-width: 100%; box-sizing: border-box; color: #000000; background-color: #E8BA40; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="#" style="display: block; width: 100%; max-width: 100%; box-sizing: border-box; background-color: #E8BA40; color: #000000; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1; text-align: center;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="#" style="display: inline-block; background-color: #E8BA40; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-size: 16px; font-weight: 500; line-height: 1;">
                                            View Dashboard
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                We noticed you haven't visited Stock Watchlist in a while. The markets have been moving, and there might be some opportunities you don't want to miss!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    ...
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Visit Stock Watchlist</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    © 2025 Stock Watchlist
                                </p>
