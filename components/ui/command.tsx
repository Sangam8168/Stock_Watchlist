...
function CommandDialog({
  ...
  // Forwarded to the inner Command. Callers that filter server-side must pass
  // false, or cmdk re-filters the results it was given and hides valid rows
  // (searching "apple" would drop AAPL, whose value is the ticker).
